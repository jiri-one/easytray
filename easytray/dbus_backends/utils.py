...
async def run_xdg_icon_resource(icon_path: Path, icon_size: int | None):
    ...
    if icon_type == 'image/svg+xml':
        ...
        icon_new_path = Path(copy2(icon_path, dst_dir))
        ...
        if icon_size is None:
            raise IconInstallationException(icon_path, "If you provide PNG icon, you have to provide icon size too.")
